...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Defect Detection", url: "/defect-detection", icon: ShieldAlert, permissions: ["wo.read"], roles: ["sys_admin","tenant_admin","ops_manager"] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Fixed Assets", url: "/fixed-assets", icon: Building2, permissions: ["finance.view"], roles: ["sys_admin","tenant_admin","finance_manager"] },
      { title: "Expense Management", url: "/expense-management", icon: ClipboardList, permissions: ["finance.view"], roles: ["sys_admin","tenant_admin","finance_manager","ops_manager","technician","dispatcher"] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Knowledge Search", url: "/knowledge-search", icon: Search, permissions: ["admin.config"] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "IoT Dashboard", url: "/iot-dashboard", icon: Cpu, permissions: ["audit.read"], roles: ["sys_admin","tenant_admin","ops_manager"] },
      { title: "Anomaly Monitor", url: "/anomaly-monitor", icon: Activity, permissions: ["fraud.view"], roles: ["sys_admin","tenant_admin","ops_manager"] },
      { title: "Auto ML Studio", url: "/auto-ml", icon: Brain, permissions: ["mlops.view"], roles: ["sys_admin","tenant_admin"] },
      { title: "Explainability", url: "/explainability", icon: Eye, permissions: ["mlops.view"], roles: ["sys_admin","tenant_admin"] },
      { title: "LLM Fine-Tuner", url: "/llm-finetune", icon: Brain, permissions: ["mlops.view"], roles: ["sys_admin","tenant_admin"] },
      { title: "Prompt Studio", url: "/prompt-studio", icon: MessageSquare, permissions: ["mlops.view"], roles: ["sys_admin","tenant_admin"] },
    ],
  },
  {
    label: "Portals",
  ...
  },
  {
    ...
    items: [
      ...
      { title: "AI Governance", url: "/ai-governance", icon: Shield, permissions: ["mlops.view"], roles: ["sys_admin","tenant_admin"] },
