...
import crmCalendarRoutes from './routes/crm-calendar.js';
...
import graphqlApiRoutes from './routes/graphql-api.js';
...
app.use('/api/crm-calendar', authenticateToken, crmCalendarRoutes);
...
app.use('/api/graphql', graphqlApiRoutes);
